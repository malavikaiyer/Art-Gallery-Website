...
<body>
   <?php include("menu.php"); ?>
    ...
    <div class="col-10" style="height:500px;width:550px;top:50px;">
       <div class="grad" style="height:400px;width:550px;position:relative;left:350px;top:50px;">
           <center>
           <p>This gallery contains information about artists and heir paintings.There are those artists who transform the sun into a yellow spot, but there are others who, with the help of their artistic prowess and talent, transform a yellow spot into the sun. </p>
	...
	<center>
            <form action="MAILTO:miyer@scu.edu?subject=Contact_through_website" method="post" enctype="text/plain">
